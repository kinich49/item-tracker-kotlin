package mx.kinich49.itemtracker.entities.usecases.sync;
...
public class ShoppingListSyncUseCaseTest {
    ...
    @InjectMocks
    ShoppingListSyncUseCase subject;
    ...
    public void shouldSyncPendingList() {
        ...
        //when
        TestObserver<Void> testObserver = subject.execute()
                .test();
