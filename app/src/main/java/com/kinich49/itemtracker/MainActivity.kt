...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val shoppintList_A = ShoppingList(1L, LocalDate.now(), 1L)
        val shoppintList_B = ShoppingList(2L, LocalDate.now(), 1L)

        shoppingListDao.insert(shoppintList_A)
...
//        shoppingListDao.getAllShoppingLists().observe(this, Observer {
